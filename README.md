...
- Github for Portfolio Building
  ...
  I performed the following steps in the course of cleaning the data I used for my analysis;
  - Data downloading and Inspection
  - Handling of missing variables
  - Data Cleaning and formatting

    ### Exploratory Data Analysis (EDA)
    EDA involves the exploration of the data set in such a I was able to answer the following questions;
    - Defense Mechanism used in combating the virus
    - Total Final losses over the years
    - Attack type and their sources
